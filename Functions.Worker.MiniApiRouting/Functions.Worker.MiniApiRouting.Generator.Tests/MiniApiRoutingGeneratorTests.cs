using Functions.Worker.MiniApiRouting.Generators;
...
namespace Functions.Worker.MiniApiRouting.Generator.Tests;
...
public sealed class MiniApiRoutingGeneratorTests
{
    ...
    public void ValidCodeEmitsReadableRouterSource()
    {
        ...
        Assert.Contains("using System.CodeDom.Compiler;", text);
        Assert.Contains("using System.Diagnostics;", text);
        Assert.Contains("[GeneratedCode(\"Functions.Worker.MiniApiRouting.Generators\", \"1.0.0.0\")]", text);
        Assert.Contains("[DebuggerNonUserCode]", text);
        Assert.Contains("[DebuggerStepThrough]", text);
